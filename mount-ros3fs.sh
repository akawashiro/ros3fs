...
GLOG_logtostderr=1 ./build/ros3fs ./build/ros3fs_mountpoint -f -d --endpoint=http://${OZONE_OM_IP}:9878 --bucket_name=bucket1/ --cache_dir=./build/ros3fs_cache_dir --update_metadata_seconds=1
